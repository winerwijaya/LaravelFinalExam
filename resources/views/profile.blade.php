...
<div style="height: auto; margin:20px">
    ...
    <form action="/profile/edit" method="post" class="ms-4" enctype="multipart/form-data">
        <h1 class="mb-3">Edit Profile</h1>
        @csrf
        <div style="margin:30px">
            <img width="400px" src="{{Storage::url(Auth::User()->display_picture_link)}}" alt="">
        </div>
        ...
        <div class="mb-3">
            ...
            <select id="role" name="role" >
                <option selected="selected">{{Auth::User()->role->role_desc}}</option>
            </select>
        </div>
        <div class="mb-3">
